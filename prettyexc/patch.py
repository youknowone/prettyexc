...
def patch(Exc, Template=PrettyException):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._delegate._type = lambda env: '' if not env.SHOW_TYPE else \
            '.'.join((self.__class__.__module__, self.__class__.__name__)) \
            if env.SHOW_MODULE is None or env.SHOW_MODULE \
    ...
    funcs = {
        '__init__': __init__, '__repr__': __repr__, '__unicode__': __unicode__,
        '__str__': __str__}
